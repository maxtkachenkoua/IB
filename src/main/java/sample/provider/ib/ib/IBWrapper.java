...
//        Controller.getInstance().orderStatus(orderId,status,filled,remaining,avgFillPrice,permId,parentId,lastFillPrice,clientId,whyHeld,mktCapPrice);
        IBHandler.getInstance().orderStatus(orderId,status,filled,remaining,avgFillPrice,permId,parentId,lastFillPrice,clientId,whyHeld,mktCapPrice);
    ...
    public void nextValidId(int orderId)
    {
        ...
        IdGenerator.getInstance().updateId(orderId);
    ...
    public void contractDetails(int reqId, ContractDetails contractDetails)
    {
        ...
        // send callback to Tushar's created class
//        ContractDetailDemo.getInstance().contractDetails(reqId,contractDetails);
    ...
    public void bondContractDetails(int reqId, ContractDetails contractDetails)
    {
        ...
        // send callback to Tushar's created class
//        ContractDetailDemo.getInstance().bondContractDetails(reqId,contractDetails);
    }
    ...
    public void contractDetailsEnd(int reqId)
    {
        ...
        // send callback to Tushar's created class
//        ContractDetailDemo.getInstance().contractDetailsEnd(reqId);
    }
    //! [contractdetailsend]
    ...
    {
//        IBHistoricalRequests.getInstance().addBar(reqId, bar);
    ...
    {
//        IBHistoricalRequests.getInstance().closeStream(reqId);
...
//        InstrumentSingleton.getInstance().updateBar(reqId,time, open, high, low, close, volume, wap, count);


        /// Calculate and/or store Technical
                               ...
                               String value, String currency)
    {
        ...
        if (tag.equals("CashBalance"))
        {
            String currentBalance = value;
            double initialCapital = Double.parseDouble(currentBalance);
            IBClient.getInstance().cancelAccountSummary(reqId);

            // it will upto date balance.
            IBHandler.getInstance().currentBalance(reqId,account,tag,value,currency);
        }
    ...
    {
//        InstrumentSingleton.getInstance().addHistoricalBar(reqId, bar);
    ...
    {
//    	InstrumentSingleton.getInstance().getInstrument(reqId).addHistoricalTicksLast(ticks, done);
    }

    @Override
    public void tickByTickAllLast(int i, int i1, long l, double v, int i2, TickAttribLast tickAttribLast, String s, String s1)
    {
//    	InstrumentSingleton.getInstance().getInstrument(i).updateTickDataLast(l, v, i1, s);
    }
    ...
    {
        //InstrumentSingleton.getInstance().getInstrument(reqId).updateBidAsk(bidPrice, askPrice);
